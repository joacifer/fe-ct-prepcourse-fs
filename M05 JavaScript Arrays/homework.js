...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numerGrande = arrayOfNums[0];
   for (let i = 1; i<arrayOfNums.length;i++){
      if(numerGrande < arrayOfNums[i]){
         numerGrande = arrayOfNums[i]
      }
   }
   return numerGrande;
}
...
function multiplicarArgumentos() {
   ...
   // Tu código:
   if (arguments.length === 0|| arguments.length < 1) return 0;// cualquiera de los 2 sirve es lo mismo
